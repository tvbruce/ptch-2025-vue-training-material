<!-- components/ComputedPropertiesDemo.vue -->
<template>
  <div class="computed-properties-demo">
    <h2>Vue 計算屬性示範 (Computed Properties)</h2>
    <p class="route-info">📍 路徑：/ComputedPropertiesDemo.vue</p>
    <p class="description">
